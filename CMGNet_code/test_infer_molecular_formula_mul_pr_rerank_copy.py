...
def main():
    # val_folder = "../../chem_data/data_pre/val"
    # val_folder = "../../chem_data/data_pre/test"
    # val_folder = "/yaolin-code/trans/chem_data/exp/202204/01_new"
    # val_folder = "/yaolin-code/trans/chem_data/exp/query_StrucRevi_20220412"
    val_folder = "exp/45mol"

    # bart_h
    # weights_path = "../../weight_smiles_decoder/20211203_bart_1/epoch_199_loss_0.014776.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": False, "molecular_weight": False, "SMILES": True}

    # weights_path = "../../weight_smiles_decoder/20211216_bart_1/epoch_199_loss_0.043917.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": True, "molecular_weight": False, "SMILES": True}

    # weights_path = "../../weight_smiles_decoder/20211221_bart_1/epoch_799_loss_0.058724.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": False, "molecular_weight": False, "SMILES": True}

    # weights_path = "../../weight_smiles_decoder/20211209_bart_1/epoch_199_loss_0.055236.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": "max", "molecular_weight": False, "SMILES": True}

    # weights_path = "../../weight_smiles_decoder/20220113_bart_1/epoch_199_loss_0.07172.pth"
    # weights_path = "../../weight_smiles_decoder/20220324_bart_3stage_1/epoch_199_loss_0.068918.pth"
    # weights_path = "../../weight_smiles_decoder/20220325_bart_3stage_1/epoch_199_loss_0.064503.pth"
    # weights_path = "../../weight_smiles_decoder/20220331_bart_onlyacd_1/epoch_199_loss_0.068821.pth"
    # weights_path = "../../weight_smiles_decoder/20220331_bart_onlyacd_2/epoch_199_loss_0.071179.pth"
    # weights_path = "../../weight_smiles_decoder/20220404_bart_3stage_long_1/epoch_199_loss_0.067575.pth"
    weights_path = "weight_smiles_decoder/20220404_bart_3stage_long_1/epoch_199_loss_0.067575.pth"
    use_dict = {"C13-NMR": True, "molecular_formula": True,
                "fragment": False, "molecular_weight": False, "SMILES": True}

# "fragment": (1)"max" (2)"min" (3)"use_3" if only 2 frag, then is 2 frag (4)True i.e. random 1 frag (5)False

    # weights_path = "../../weight_smiles_decoder/20220114_bart_1/epoch_399_loss_0.062657.pth"
    # weights_path = "../../weight_smiles_decoder/20220114_bart_1/epoch_199_loss_0.070673.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": True, "molecular_weight": False, "SMILES": True}

    # weights_path = "../../weight_smiles_decoder/20220119_bart_1/epoch_199_loss_0.120616.pth"
    # use_dict = {"C13-NMR": True, "molecular_formula": True,
    #             "fragment": "max", "molecular_weight": False, "SMILES": True}
    ...
    # save_path = "../../chem_data/exp_result/query_StrucRevi_20220412_val_rule_nmr.cmc"
    save_path = "exp_result/45Struc_query_fml_out_20221027.cmc"
